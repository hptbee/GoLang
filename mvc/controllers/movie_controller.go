...
func (c *MovieController) GetBy(id int64) (movie viewmodels.Movie, found bool) {
...
func (c *MovieController) PutBy(ctx iris.Context, id int64) (viewmodels.Movie, error) {
	// get the request data for poster and genre
	file, info, err := ctx.FormFile("poster")
	if err != nil {
		return viewmodels.Movie{}, errors.New("failed due form file 'poster' missing")
	}
